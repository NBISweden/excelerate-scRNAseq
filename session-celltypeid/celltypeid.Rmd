...
leukycytes as well as tumor cells.
...
To get a good overview it's easist to iterate over all elements of this
list.
...
using the bulikified CHETAH reference, whereas the `celltype_CHETAH`
