Elixir scRNA-seq course Finland 2019: Normalization and selection of
variable genes
================
Heli Pessa
27 May 2019

In this exercise session, we normalize the data and select highly
variable genes comparing two analysis packages, scran and Seurat. We use
also the scater package for visualization.
...
The data can be downloaded with the following command, but it is already
included in the course repository. This is one of the 10X datasets used
also in the QC
session.
...
![](Normalization_with_answers_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
![](Normalization_with_answers_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->

Plot the expression of the B cell marker
MS4A1.
...
![](Normalization_with_answers_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
some marker genes, for example GNLY (NK cells) or LYZ
(monocytes).
...
![](Normalization_with_answers_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](Normalization_with_answers_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](Normalization_with_answers_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](Normalization_with_answers_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](Normalization_with_answers_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](Normalization_with_answers_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
```
    ...
    ## CD74    1.37040019152026 6.00496990106006e-272 3.15447280940514e-269
...
![](Normalization_with_answers_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
![](Normalization_with_answers_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](Normalization_with_answers_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
...
```
    ...
    ##  [13] splines_3.5.2            R.methodsS3_1.7.1       
